...
# I'm using paru but feel free to use any aur helper if you are on arch
 paru -S --needed --noconfirm waybar-hyprland-git hyprland-bin swaylock swaybg grim wofi kitty lxappearance qt5ct qt6ct kvantum awesome-terminal-fonts adobe-source-code-pro-fonts ttf-jetbrains-mono
